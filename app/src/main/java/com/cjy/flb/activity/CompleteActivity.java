...
public class CompleteActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout llComplete, llSex;
    ...
    private ArrayList<String> brith1Items = new ArrayList<>();
    private ArrayList<ArrayList<String>> brith2Items = new ArrayList<>();
    ...
    public void initView() {
        ...
        initBar(getString(R.string.complete_information), false, false);
    }
    ...
    public void initData() {
        ...
        llComplete = (LinearLayout) findViewById(R.id.ll_complete);
     ...
     * 解除药盒
     */
    private void showAddMedicDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CompleteActivity.this);
        builder.setMessage(getString(R.string.give_up_binding))
    ...
    private void onRemovePCS(final DialogInterface dialog) {
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, MHttpUtils.REMOVE_DEVICE, requestParams,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                       KLog.json(responseInfo.result);
                        try {
                            ...
                            if (codeElement.getAsInt() == 1) {
                                AppManager.getAppManager().finishActivity(AddFlbActivity.class);
                                AppManager.getAppManager().finishActivity(CompleteActivity.class);
                                startActivity(new Intent(context, PCSOfNetworkTypeActivity.class));
                                dialog.dismiss();
                            }
                    ...
                    public void onFailure(HttpException e, String s) {
                        ToastUtil.showShort(getString(R.string.remove_box_error));
                        dialog.dismiss();
                    }
                });
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_toMain://提交资料
                if (etFlbUserName.getText().toString().trim().length() <= 0 ||
                    ...
                    MHttpUtils.completeFlb(uId, uName, uPhone, uYear, uMouth, isSex, c1Name, c1Phone,
                            c2Name, c2Phone, dName, dPhone, uAvatar, context);
                }
                break;
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(nameEdit.getText().toString().trim()) ||
                    ...
                    etContact.setText(new StringBuilder()
                            ...
                            .append("/")
                            .append(phoneEdit.getText().toString().trim()).toString());
                    mDialog.dismiss();
                }
            }
        });
    ...
    private void setContact(TextView etContact, String name, String phone) {
        etContact.setText(new StringBuilder().append(name).append("/").append(phone).toString());
    }
    ...
    private void chooseData() {
        ...
        pwBrith.setOnoptionsSelectListener(new BrithPopupWindow.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int option2) {
                String brith = brith1Items.get(options1) + getString(R.string.pickerview_year) +
                        brith2Items.get(0).get(option2) + getString(R.string.pickerview_month);
